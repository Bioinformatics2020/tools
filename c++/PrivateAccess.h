...
auto& PrivateAccess(Class &Obj, const Type &Target) { return Obj.*Target; }

template <typename Class, typename Type>
auto& PrivateAccess(Class *Ptr, const Type &Target) { return Ptr->*Target; }

template <typename Type>
auto& PrivateAccess(const Type &Target) { return *Target; }
...
class FTestClass
{
    ...
    static bool Register(const FTestClass *Ptr)
    {
        Instance = Ptr;
        return true;
    }
...
const FTestClass *FTestClass::Instance = nullptr;
...
inline void PrivateAccessorTest()
{
    ...
    (Ptr->*TestClassRegister2)(TestClassIndexMap);
