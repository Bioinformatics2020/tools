...
void SGeneratePackage::Construct(const FArguments &InArgs)
{
    ...
    if(!GConfig->GetString(TEXT("HotUpdateEditorTool"),TEXT("PackagePath"), PackagePath, GEditorIni) || PackagePath.IsEmpty())
    {
        PackagePath = FPaths::ProjectDir() + TEXT("Package/");
    }
    ...
    [
        ...
        [
            ...
            [
                ...
                .HintText(FText::FromString(PackagePath))
